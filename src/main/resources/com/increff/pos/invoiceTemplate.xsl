          ...
          <fo:table>
            ...
            <fo:table-body>
              <fo:table-row>
                ...
                <fo:table-cell text-align="left" padding-bottom="2px" padding-top="2px">
                  <fo:block><xsl:value-of select="dates"/></fo:block>
                </fo:table-cell>
              </fo:table-row>
            </fo:table-body>
          </fo:table>
          <fo:table>
            ...
            <fo:table-body>
              <fo:table-row>
                ...
                <fo:table-cell text-align="left" padding-bottom="2px" padding-top="2px">
                  <fo:block><xsl:value-of select="times"/></fo:block>
                </fo:table-cell>
              </fo:table-row>
            </fo:table-body>
          </fo:table>	
          ...
          <fo:table>
            ...
            <fo:table-body>
              <fo:table-row>
                ...
                <fo:table-cell text-align="left" padding-bottom="2px" padding-top="2px" border-bottom="1px solid #eee">
                  <fo:block font-weight="bold">Total Cost</fo:block>
                </fo:table-cell>
                <fo:table-cell text-align="left" padding-bottom="2px" padding-top="2px" border-bottom="1px solid #eee">
                  <fo:block><xsl:value-of select="totalCost"/></fo:block>
                </fo:table-cell>
              </fo:table-row>
